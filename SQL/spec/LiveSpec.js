  ...
  it("Should insert posted messages to the DB", function(done) {
    ...
    request({method: "POST",
            ...
            function(error, response, body) {
              ...
              var queryString = 'select users.username, messages.text, rooms.roomname from users inner join messages on users.id = messages.id_users inner join rooms on messages.id_rooms = rooms.id';
              var queryArgs = [];
